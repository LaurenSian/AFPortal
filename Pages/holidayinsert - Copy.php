...
$insertsql = "INSERT INTO Holiday (Employee_ID, Holiday_DateofRequest, Holiday_StartDate, Holiday_EndDate, Holiday_NoDays, Holiday_Reason, Holiday_Status)
        VALUES ('AF002', 'NOW()', ?, ?, ?, ?, 'pending')";

$stmt = mysqli_prepare($insertsql);

$stmt->bind_param("issssiss", $_POST['username'], $_POST['email'], $_POST['password']);
        ...
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-pastholiday">
                    ...
                    <tbody>
                          <form action="">
                          <td><input type="datetime-local" name=holstart></td>
                          <td><input type="datetime-local" name=holend></td>
                          <td><input type="number" name=nodays></td>
                          <td><input type="text" name=holend></td></td>
